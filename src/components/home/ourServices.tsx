...
const SERVICES_DATA = [
  {
    ...
    title: "Buy Property",
    description:
      "Find and purchase your dream property with our expert guidance.",
    icon: Key,
  ...
  },
  {
    ...
    title: "Rent Property",
    description:
      "List or find rental properties with our comprehensive database.",
    icon: Building2,
  ...
  },
  {
    ...
    title: "Home Loans",
    description:
      "Get competitive loan rates from leading banks through our partnerships.",
    icon: CreditCard,
...
export default function OurServicesPremium() {
  return (
    <section className="relative w-full bg-[#fcf8fa] py-14 font-['Inter'] selection:bg-[#0051d5]/20">
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-12 lg:gap-12">
          ...
          >
            <div className="sticky top-32 flex flex-col items-start">
             ...
             <p className="mb-0 lg:mb-8 max-w-md text-[18px] text-[#45464d] font-normal leading-[1.6]">
                End-to-end real estate services under one roof. We handle the
                complexities so you can focus on the luxury of the experience.
              </p>
      ...
      <div>
        ...
        <ul className="mb-8 space-y-3">
          {service.features.map((feature, idx) => (
            <li
              key={idx}
              className="flex items-start gap-3 text-[14px] font-medium text-[#45464d]"
            >
