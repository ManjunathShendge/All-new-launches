...
export default async function BlogListingPage({
  ...
  return (
    <main className="min-h-screen w-full bg-[#fcf8fa] font-['Inter'] selection:bg-[#0051d5] selection:text-white">
      ...
      {/* HERO SECTION */}
      <section className="relative isolate flex min-h-125 w-full flex-col items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-10 bg-linear-to-b from-[#1b1b1d]/80 via-[#1b1b1d]/60 to-[#fcf8fa]" />
